...
Color accent0 = Color(0xFF121212);
...
Color textColorDark = Color(0xFFF2F2F2);
Color primaryAccent0Dark = Color(0xFF121212);
...
// light mode
Color primaryColorLight = Color(0xFFD7D7D7);
Color secondaryColorLight = Color(0xFF0066FF);    // blue just to differentiate it from dark mode a bit for now
Color textColorLight = Color(0xFF121212);
Color primaryAccent0Light = Color(0xFFC5C5C5);  // set value lower RGB than primary
