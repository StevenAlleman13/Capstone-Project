...
class EventsPage extends StatefulWidget {
  ...
  EventsPage({super.key, this.onViewModeChanged});
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              IconButton(
                icon: Icon(Icons.chevron_left, color: m.textColor),
              ...
              IconButton(
                icon: Icon(Icons.chevron_right, color: m.textColor),
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  ...
                  splashColor: m.textColor.withOpacity(0.1),
                  highlightColor: m.textColor.withOpacity(0.05),
                  borderRadius: BorderRadius.circular(50),
                  child: Container(
                    decoration: BoxDecoration(
                      color: isSelected
                          ? m.textColor.withOpacity(0.2)
                          : isToday
                          ? m.textColor.withOpacity(0.1)
                          : Colors.transparent,
...
class _AddEventTaskSheetState extends State<AddEventTaskSheet> {
    ...
    return AnimatedPadding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border(
            top: BorderSide(
              color: m.secondaryColor.withOpacity(0.3),
              width: 1,
            ),
          ),
        ),
        ...
        children: [
          ...
          _card(
            children: [
              ...
              Divider(height: 1, color: m.textColor.withAlpha(31)),
  ...
  Widget _locationRow() {
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(Icons.location_on, color: m.secondaryColor, size: 20),
            ...
            if (_pickedLocation != null)
              GestureDetector(
                ...
                child: Icon(Icons.close, color: m.textColor.withAlpha(138), size: 18),
              ),
          ],
        ),
      ),
        ...
        children: List.generate(7, (i) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              height: 36,
              decoration: BoxDecoration(
                color: sel ? m.secondaryColor : m.accent1,
                shape: BoxShape.circle,
                border: Border.all(
                  color: m.secondaryColor.withOpacity(sel ? 0.6 : 0.2),
                ),
              ),
              ...
              child: Text(
                dayLabels[i],
                style: TextStyle(
                  color: sel ? m.primaryColor : m.accent4,
                  fontWeight: FontWeight.w600,
                  shadows: const [],
                ),
              ),
          ...
          if (time != null) ...[
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isExpanded
                      ? m.secondaryColor.withOpacity(0.15)
                      : m.accent1,
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
                    color: m.secondaryColor.withOpacity(isExpanded ? 0.4 : 0.2),
                  ),
                ),
                child: Text(
        ...
        child: Stack(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: m.secondaryColor.withOpacity(0.06),
  ...
  Widget _card({required List<Widget> children}) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: m.secondaryColor.withOpacity(0.15)),
      ),
  ...
  Widget _textField(TextEditingController ctl, String hint) {
    return TextField(
      controller: ctl,
      style: TextStyle(color: m.textColor, fontSize: 16, shadows: []),
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: TextStyle(color: m.accent4, shadows: []),
      ...
      child: Row(
        children: [
          ...
          Switch(
            value: value,
            onChanged: onChanged,
            activeThumbColor: m.secondaryColor,
          ),
        ],
      ),
    );
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: m.accent1,
          borderRadius: BorderRadius.circular(8),
          border: Border.all(color: m.secondaryColor.withOpacity(0.2)),
        ),
        child: Text(
          text,
          style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Divider(height: 1, color: m.secondaryColor),
          // Map
          Expanded(
          ...
          if (_pinned != null)
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: m.textColor.withAlpha(138),
                  fontSize: 13,
                  shadows: [],
                ),
