                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(color: m.textColor.withAlpha(138)),
                      ),
                      validator: (v) {
                        final s = (v ?? '').trim();
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, i) {
              ...
              return ListTile(
                ...
                subtitle: Text(
                  'Tap to favorite',
                  style: TextStyle(color: m.textColor.withOpacity(0.7)),
                ),
                trailing: Icon(
                  Icons.chevron_right,
                  color: m.textColor.withAlpha(138),
                    ...
                    AspectRatio(
                      ...
                      child: Image.network(
                        ...
                        errorBuilder: (_, __, ___) =>
                            Container(color: m.primaryColor),
                      ),
                    )
                  else
                    Container(height: 110, color: m.primaryColor),
                  Positioned(
                    top: 6,
                    right: 6,
                    child: Material(
                      color: m.primaryColor.withOpacity(0.6),
              ...
              if (recipe.missingIngredients.isNotEmpty)
                Padding(
                  ...
                  child: Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: m.textColor.withOpacity(0.80),
                    ),
                  ),
                ),
            ],
  ...
  Widget build(BuildContext context) {
    return Opacity(
      ...
      child: Text(
        ...
        style: Theme.of(
          context,
        ).textTheme.bodyMedium?.copyWith(color: m.textColor.withOpacity(0.85)),
      ),
    );
  }
}
