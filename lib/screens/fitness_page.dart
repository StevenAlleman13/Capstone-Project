...
class FitnessPageState extends State<FitnessPage> {
  ...
  void _showGoalReachedBanner() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Row(
          children: [
            Icon(Icons.emoji_events, color: m.secondaryColor),
            SizedBox(width: 10),
            Expanded(
              child: Text(
  ...
  void _showSetGoalDialog() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Set Goal Weight', style: TextStyle(color: m.secondaryColor)),
        content: TextField(
    ...
    return (await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(
              ...
              style: TextStyle(color: m.secondaryColor.withOpacity(0.9)),
            ),
            actions: [
              TextButton(
  ...
  void _showSetMacroGoalsDialog() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Set Macro Goals', style: TextStyle(color: m.secondaryColor)),
          ...
          child: Column(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  color: m.secondaryColor.withOpacity(0.7),
                  fontSize: 12,
                ),
              ),
              SizedBox(height: 16),
            ...
            Expanded(
              child: ListView.separated(
                ...
                separatorBuilder: (_, __) =>
                    Divider(color: m.secondaryColor.withOpacity(0.2)),
      ...
      children: [
        OutlinedButton(
          ...
          style: OutlinedButton.styleFrom(
            side: BorderSide(color: m.secondaryColor, width: 1.5),
            foregroundColor: m.secondaryColor,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(_cornerRadius),
            ),
          ),
        ...
        if (!goalsSet) ...[
          ...
          Text(
            ...
            style: TextStyle(color: m.secondaryColor.withOpacity(0.5), fontSize: 11),
        ...
        children: [
          InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Icon(icon, color: m.secondaryColor, size: 20),
                  SizedBox(width: 10),
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: Theme.of(
                            context,
                          ).textTheme.titleLarge?.copyWith(color: m.textColor),
                        ),
                        if (!expanded && subtitle != null) ...[
                          ...
                          Text(
                            subtitle,
                            style: TextStyle(
                              color: m.secondaryColor.withOpacity(0.8),
                              fontSize: 11,
                            ),
                          ),
                        ],
                  ...
                  if (infoText != null) ...[
                    _InfoButton(infoText: infoText, iconColor: m.secondaryColor),
                    SizedBox(width: 4),
                  ],
                  Icon(
  ...
  InputDecoration _inputDecoration(String label) {
    return InputDecoration(
      labelText: label,
      labelStyle: TextStyle(color: m.secondaryColor),
        ...
        children: [
                ...
                if (ingredients.isNotEmpty) ...[
                  Padding(
                    ...
                    child: Text(
                      'INGREDIENTS',
                      style: TextStyle(
                        color: m.secondaryColor.withOpacity(0.6),
                        fontSize: 11,
                        letterSpacing: 1.2,
                      ),
                    ),
                ...
                if (ingredients.isEmpty && recipes.isEmpty)
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: m.secondaryColor.withOpacity(0.7)),
                      textAlign: TextAlign.center,
                    ),
                  ),
              ],
          ...
          if (_selected != null)
            Container(
              ...
              decoration: BoxDecoration(
                border: Border(
                  top: BorderSide(color: m.secondaryColor.withOpacity(0.3)),
                ),
                color: m.primaryColor,
              ),
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      DropdownButton<String>(
                        value: _unit,
                        dropdownColor: m.primaryColor,
                        style: TextStyle(color: m.secondaryColor),
                        underline: Container(height: 1, color: m.secondaryColor),
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      foregroundColor: m.primaryColor,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(_cornerRadius),
                      ),
                    ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected
                ? m.secondaryColor
                : m.secondaryColor.withOpacity(noNutrition ? 0.2 : 0.45),
            width: isSelected ? 2 : 1,
          ),
          color: isSelected ? m.secondaryColor.withOpacity(0.08) : Colors.transparent,
        ),
        child: Row(
          children: [
            Icon(
              opt.type == 'ingredient' ? Icons.restaurant : Icons.menu_book,
              color: noNutrition ? m.secondaryColor.withOpacity(0.3) : m.secondaryColor,
              size: 18,
            ),
            SizedBox(width: 10),
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      color: noNutrition
                          ? m.secondaryColor.withOpacity(0.35)
                          : m.secondaryColor,
                  ...
                  if (noNutrition)
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        color: m.secondaryColor.withOpacity(0.65),
                        fontSize: 11,
                      ),
                    )
                  else
            ...
            if (isSelected)
              Icon(Icons.check_circle, color: m.secondaryColor, size: 18),
          ],
        ),
      ),
    );
                  ...
                  if (fillWidth > 0)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(999),
                        color: overGoal
                            ? m.secondaryColor.withOpacity(0.5)
                            : m.secondaryColor,
                        boxShadow: [
                          BoxShadow(
...
class _WeightGraphPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (points.length == 1) {
      ...
      final dotPaint = Paint()..color = m.secondaryColor;
  ...
  void _drawNoData(Canvas canvas, Rect plotRect) {
    final textPainter = TextPainter(
      text: TextSpan(
        text: 'No data yet',
        style: TextStyle(color: m.secondaryColor, fontSize: 14),
      ),
      textDirection: TextDirection.ltr,
    )..layout();
  ...
  void _drawAxisLabels(
    ...
    final labelStyle = TextStyle(color: m.secondaryColor, fontSize: 11);
  ...
  void _drawGridLines(Canvas canvas, Rect plotRect) {
    final gridPaint = Paint()
      ..color = m.secondaryColor.withOpacity(0.25)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1;
  ...
  void _drawXAxisLabels(Canvas canvas, Rect plotRect, List<_WeightPoint> pts) {
    ...
    final labelStyle = TextStyle(color: m.secondaryColor, fontSize: 10);
